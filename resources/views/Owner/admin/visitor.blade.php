            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/ownervisitor/create" method="POST">
                            {{csrf_field()}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-left">
                            <a class="btn btn-primary btn-sm" href="/ownervisitor/{{$profil->id}}/detail">
                                <i class="fas fa-search-plus">
                                </i>
                                View
                            </a>
                            <a class="btn btn-info btn-sm" href="/ownervisitor/{{$profil->id}}/edit">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="/ownervisitor/{{$profil->id}}/delete"
