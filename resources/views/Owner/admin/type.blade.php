            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/ownertype/create" method="POST">
                            {{csrf_field()}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-left">
                            <a class="btn btn-primary btn-sm" href="/ownertype/{{$room->id}}/view">
                                <i class="fas fa-search-plus">
                                </i>
                                View
                            </a>
                            <a class="btn btn-info btn-sm" href="/ownertype/{{$room->id}}/edit">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="/ownertype/{{$room->id}}/delete"
