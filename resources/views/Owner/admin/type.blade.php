            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/owner/type/create" method="POST">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label>ID Homestay</label>
                                <input name="homestay_id" type="text" class="form-control" placeholder="ID Homestay">
                            </div>
                            <div class="form-group">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-left">
                            <a class="btn btn-primary btn-sm" href="/owner/type/{{$room->id}}/view">
                                <i class="fas fa-search-plus">
                                </i>
                                View
                            </a>
                            <a class="btn btn-info btn-sm" href="/owner/type/{{$room->id}}/edit">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="/owner/type/{{$room->id}}/delete"
