            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview">
                            <a href="./ownerdashboard" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="./ownerbooking" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="./ownervisitor" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./ownerhomestay" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="./ownerreview" class="nav-link">
