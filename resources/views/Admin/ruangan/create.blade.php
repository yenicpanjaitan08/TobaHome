        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Input Info Ruangan</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Form Input Informasi Ruangan TobaHome</h3>
        ...
        <div class="card-body">
            ...
            <form action="{{route('ruangan.store')}}" method="POST">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-info col-md-8">Tambahkan Informasi Ruangan</button>
                </div>
            </form>
