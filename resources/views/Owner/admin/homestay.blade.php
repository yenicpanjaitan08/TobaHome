            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/owner/homestay/create" method="POST">
                            {{csrf_field()}}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions text-left">
                            <a class="btn btn-primary btn-sm" href="/owner/homestay/{{$homestay->id}}/view">
                                <i class="fas fa-search-plus">
                                </i>
                                View
                            </a>
                            <a class="btn btn-info btn-sm" href="/owner/homestay/{{$homestay->id}}/edit">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="/owner/homestay/{{$homestay->id}}/delete"
