...
<body>
        ...
        <div class="top-nav">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="tn-right">
                            <a href="/visitor/homestay" class="bk-btn">Booking Now</a>
                            <div class="language-option">
                                <span><img src="img/user.png" alt=""> <i class="fa fa-angle-down"></i></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    <li class="active"><a href="/visitor">Home</a></li>
                                    <li><a href="/visitor/rooms">Rooms</a>
                                        <ul class="dropdown">
                                            <li><a href="./visitor/rooms">Rooms</a></li>
                                            <li><a href="./facility">Facility</a></li>
                                        </ul>
                                    </li>

                                    <li><a href="./visitor/blog">News</a>
                                        <ul class="dropdown">
                                            <li><a href="./visitor/blog">Blog</a></li>
                                            <li><a href="./visitor/gallery">Gallery</a></li>
                                            <li><a href="./visitor/reviews">Review</a></li>
                                        </ul>
                                    </li>

                                    <li><a href="./visitor/aboutus">About Us</a></li>
                                    <li><a href="./visitor/contact">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('asset/template/fonts/font-awesome-4.7.0/css/font-awesome.min.css')}}">
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="{{asset('asset/template/fonts/Linearicons-Free-v1.0.0/icon-font.min.css')}}">
    <!--===============================================================================================-->
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css"
        href="{{asset('asset/template/vendor/daterangepicker/daterangepicker.css')}}">
    <!--===============================================================================================-->
