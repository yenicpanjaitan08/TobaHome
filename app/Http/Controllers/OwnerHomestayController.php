...
class OwnerHomestayController extends Controller
{
    public function homestay(){
        ...
        return view('Owner.admin.homestay',['data_homestay'=> $data_homestay]); 
    }

    public function view($id){
        $data_homestay = \App\Homestay::find($id);
        return view('Owner.homestay.detail',['data_homestay'=> $data_homestay]); 
    }
    

    public function create(Request $request){
        \App\Homestay::create($request->all());
        return redirect('/owner/homestay')->with('sukses','Data Save Successfully');
    }

    public function edit($id){
        $data_homestay = \App\Homestay::find($id);
        return view('Owner.homestay.edit', ['data_homestay'=> $data_homestay]);
    }
    ...
    public function delete($id){
        ...
        return redirect('/owner/homestay')->with('sukses','Data Delete Successfully');
    }
